...
<div class="notification-bar mobilehide" style="background-color: #35A5B1">
    <a href="#" class="notification-bar__message">We are available for worldwide shipping! Click here for T&amp;C</a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                ...
                <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                    ...
                    <li class="lvl1"><a href="{{ route('collection.publik') }}">Collections</a></li>
